    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gps', django.contrib.postgres.fields.hstore.HStoreField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('AA', 'Accepted'), ('PP', 'Pending'), ('RR', 'Denied'), ('DD', 'Declined')], default='PP', max_length=2, verbose_name='status_participant_choices')),
            ],
            options={
