...
MIGRATION_MODULES = {"sites": "myhandycrafts.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "myhandycrafts.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Margareth Davila Gutierrez""", "magui19.jems@gmail.com")]
...
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# ACCOUNT_ADAPTER = "myhandycrafts.users.adapters.AccountAdapter"
# # https://django-allauth.readthedocs.io/en/latest/configuration.html
# SOCIALACCOUNT_ADAPTER = "myhandycrafts.users.adapters.SocialAccountAdapter"
# *********************
# django-compressor
# ------------------------------------------------------------------------------
